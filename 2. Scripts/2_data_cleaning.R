...
df %>% select(c("age", "cuentaPropia", "formal", "y_total_m", "microEmpresa", "totalHoursWorked", "female", "primaria", "secundaria", "media", "universitaria", "estrato_medio", "estrato_alto")) %>% chart.Correlation()
